...
function AdminCategoryEditPage() {
    ...
    return (
        <AdminContainer>
            ...
            <Card>
                {isLoading ? (
                    <AdminLoadingText>...</AdminLoadingText>
                ) : (
